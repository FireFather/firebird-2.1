...
void SortOrdinary( typeMoveList *m1, typeMoveList *m2, const uint32_t s1, const uint32_t s2, const uint32_t s3 )
    {
    typeMoveList *p, *q;
...
typeMoveList *EvasionMoves( typePos *Position, typeMoveList *list, const uint64_t mask )
    {
    if( Position->wtm )
...
typeMoveList *MyPositionalGain( typePos *Position, typeMoveList *List, const int av )
    {
