...
char* Notate(const uint32_t move, char* M)
{
	const char c[16] = "0123nbrq";
...
void InitBitboards(typePos* Position)
{
	...
	uint64_t O = Position->OccupiedBW;
...
void NewGame(typePos* Position, const boolean full)
{
	int i;
