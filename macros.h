...
#ifdef MultiPosGain
int16_t MaxPositionalGain[MaxCPUs][0x10][010000];
...
#ifdef MultiHistory
uint16_t HISTORY[MaxCPUs][0x10][0100];
...
#define Value4(w,x,y,z) ((((uint64_t) (z)) << 48) + (((uint64_t) (y)) << 32) + (((uint64_t) (x)) << 16) + (((uint64_t) (w)) << 0))
