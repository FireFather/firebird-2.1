...
static int InitFlags(const int wP, const int wN, const int wB, const int wBL, const int wBD, const int wR, const int wQ, const int bP, const int bN, const int bB, const int bBL,
                     const int bBD, const int bR, const int bQ)
    {
...
static int InitTokens(const int wP, const int wN, const int wB, const int wBL, const int wBD, const int wR, const int wQ, const int bP, const int bN, const int bB, const int bBL,
                      const int bBD, const int bR, const int bQ)
    {
    int token = 0x80;
...
static uint64_t ComputeValue( const int wP, const int wN, const int wB, const int wR, const int wQ, const int bP, const int bN, const int bB, const int bR, const int bQ )
    {
    uint64_t va = 0;
...
static void CalculateMaterialValue(const int c )
    ...
    uint64_t va = ComputeValue(wP, wN, wB, wR, wQ, bP, bN, bB,bR, bQ);
